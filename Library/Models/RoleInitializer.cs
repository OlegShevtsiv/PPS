...
namespace Library.Models
{
    public class RoleInitializer
    {
        public static async Task InitializeAsync(UserManager<User> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            {
                User UserAdmin = new User { Name = "Oleg Shevtsiv", Email = UserAdminEmail, UserName = UserAdminEmail };
            ...
            {
                User LibraryAdmin = new User { Name = "Jhon Smow", Email = LibraryAdminEmail, UserName = LibraryAdminEmail };
